...
function changename(){
    if(document.getElementById('button-play').textContent=="Iniciar"){
        document.getElementById('button-play').textContent="Pausado"
    } 
    else{
        document.getElementById('button-play').textContent="Iniciar"
    }
}
